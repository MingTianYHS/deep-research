...
def check_repo(repo_root: Path) -> dict[str, Any]:
    ...
    if not (repo_root / "tests").exists(): warnings.append("tests directory missing")
    ...
    if not (repo_root / "scripts/lifecycle_smoke_test.py").exists(): warnings.append("lifecycle smoke test missing")
