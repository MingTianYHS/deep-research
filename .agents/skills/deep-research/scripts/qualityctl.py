...
def cmd_quality(args: argparse.Namespace) -> None:
    ...
    result = evaluate(cards, load_policy(POLICY_FILE), date.fromisoformat(args.as_of) if args.as_of else None)
...
def parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="qualityctl")
    sub = p.add_subparsers(dest="command", required=True)
    quality = sub.add_parser("quality-report")
    quality.add_argument("slug")
