...
def build_attempt(
    ...
    *,
    ...
    access_mode: str = "public_static",
    query_id: str | None = None,
    discovery_method: str = "known_url",
    discovered_via_source_attempt_id: str | None = None,
) -> dict[str, Any]:
    ...
    return {
        ...
        "discovered_via_source_attempt_id": discovered_via_source_attempt_id,
        **assessment,
    }
