...
def check_repo(repo_root: Path) -> dict[str, Any]:
    errors: list[str] = []; warnings: list[str] = []; skill = repo_root / ".agents/skills/deep-research"; agents = repo_root / ".codex/agents"
    ...
    project = project_version(repo_root); skill_release = skill_version(skill_text)
